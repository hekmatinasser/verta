...
همچنین برای پارس کردن تاریخ شمسی به صورت رشته و استفاده کردن آن در مدل های لاراول می توانید از ترکیب دستورات زیر استفاده کنید
بدین صورت که ابتدا رشته با تبدیل به یک آبجکت از ورتا کرده و بعد آبجکت ورتا را به کربن تبدیل میکنید. فیلد هایی که از جنس تایم استمپ هستند
می توانید به آنها متغیری از جنس کربن بدهید.
```php
$v = Verta::parse('1395-10-07 14:12:32');
